...
// TODO
val newDataDF = spark.sql("select * from demo_iot_data_delta")
...
// TODO
val newDeviceId485DF = newDataDF
...
// TEST - Run this cell to test your solution.
 val actionCount = newDeviceId485DF.select("Action").count
//display(actionCount)
